...
<div class="container p-2">
    ...
    <span class="frankie text-atl-red text-6xl">
        19h
        <a href="https://osm.org/go/0AU8MOGON?way=68947126" target="blank">
            <Icon data={map} class="w-8 h-8" />
        </a>
    </span>
    <h2 class="text-xl lg:text-2xl text-atl-red font-bold">
        <a href="https://cafeshistoriques.com/programme/la-rencontre-de-louis-rimbault-et-des-causeries-anarchistes">"A la rencontre de Louis Rimbault et des causeries anarchistes"</a>
    </h2>
