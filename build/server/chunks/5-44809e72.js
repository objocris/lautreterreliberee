...
const ardoises = [
  ...
  },
  {
    ...
    texteAudio: [
      ...
      "<i>Le narrateur</i> : Comme vous, nous nous sommes dit que cette salade, aussi bonne et appétissante soit-elle, devait tout de même prendre un certain temps pour être préparer. Et évidemment, Louis Rimbault avait anticipé cette remarque, et nous vous laissons la joie d’en découvrir la réponse : ",
...
const index = 5;
const component = async () => (await import('./_page.svelte-80c55984.js')).default;
const server_id = "src/routes/(app)/balade-sonore/[slug]/+page.server.ts";
const imports = ["_app/immutable/nodes/5.d7308a3e.js","_app/immutable/chunks/index.5fb73ef7.js"];
const stylesheets = ["_app/immutable/assets/5.91d09ae9.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server_ts as server, server_id, stylesheets };
//# sourceMappingURL=5-44809e72.js.map
