import { c as create_ssr_component, d as add_attribute, v as validate_component, h as compute_rest_props, f as each, i as spread, j as escape_object, e as escape, k as escape_attribute_value, l as globals } from './index3-b7b71654.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="container p-2"><div class="img-header text-center flex justify-center mb-10"><img${add_attribute("src", afficheSansTexte, 0)} alt="Affiche Champ Libre 2023" class="w-60 max-w-full"></div>
    ...
    <span class="frankie text-atl-red text-6xl">10h30
        <a href="https://osm.org/go/0AU8MOGON?way=68947126" target="blank">${validate_component(Icon, "Icon").$$render($$result, { data: map, class: "w-8 h-8" }, {}, {})}</a></span>
    <h2 class="text-xl lg:text-2xl text-atl-red font-bold">Balade sonore</h2>
    ...
    <span class="frankie text-atl-red text-6xl">12h30
    ...
    <h2 class="text-xl lg:text-2xl text-atl-red font-bold">Pique-nique partagé — Causeries</h2>
    ...
    <span class="frankie text-atl-red text-6xl">14h
        <a href="https://osm.org/go/0AU8Qn3Nl-?m=" target="blank">${validate_component(Icon, "Icon").$$render($$result, { data: map, class: "w-8 h-8" }, {}, {})}</a></span>
    <h2 class="text-xl lg:text-2xl text-atl-red font-bold">Fresque du climat et ateliers ludiques</h2>
    <p class="text-base lg:text-2xl mb-4">L’approche ludique et pédagogique de la Fresque du Climat permet à chacun de comprendre le fonctionnement, l’ampleur et la complexité des enjeux liés aux dérèglements climatiques. L’atelier mobilise l’intelligence collective pour sensibiliser les participants aux changements climatiques.
    ...
    <span class="frankie text-atl-red text-6xl">18h
        <a href="https://osm.org/go/0AU8Qn3Nl-?m=" target="blank">${validate_component(Icon, "Icon").$$render($$result, { data: map, class: "w-8 h-8" }, {}, {})}</a></span>
    <h2 class="text-xl lg:text-2xl text-atl-red font-bold">Vélo Sound System</h2>
...
//# sourceMappingURL=_page.svelte-246adcaf.js.map
