...
const ardoises = [
  ...
  },
  {
    ...
    texteAudio: [
      "<i>Le narrateur</i> : Louis Rimbault est mort en 1949. C’est un peu trop loin pour trouver des témoignages directs. Pour autant, certains ici se souviennent de leurs parents, de leurs grand-parents et des histoires, des rumeurs qu’on leur racontaient sur ce fameux Rimbault. Son voisin Bernard, âgé de trois ans à la mort de Rimbault n’a jamais oublié l’image du corbillard venu chercher son corps.",
      "<i>Bernard M</i> : Ah ben oui ça je m’en rappelle comme si c’était hier hein… j’m’en rappelle j’les vois encore passer là… y’a des trucs qui marquent…. Oui, bien moi, je me rappelle de voir les chevaux passer là, des chevaux blancs en plus… là ils couraient un peu là, ils marchainet pas ils couraient les chevaux et l’mien était noir, c’est ce que j’avais dit, soi disant, je ne me rappelle pas de ça, mais ma mère m’a dit ça, le corbillard a passé là. Et puis par contre, quand il est reparti, il est reparti par ce chemin là qu’il n’avait pas le droit. Il n’avait  pas le droit hein, c’est un chemin privé. Il n’avait pas à repasser par ici.",
      ...
      "<i>Michel Ragot</i> :  Et ils appelaient ça la confrérie des non bâtisseurs. Comme il y a des maisons qui étaient commencées, jamais finies… Il commençaient, et finissaient rien… Et pourtant c’était joli ce qu’ils faisaient et c’était costaud…",
...
function load({ params }) {
  ...
  if (!ardoise)
    throw redirect(307, "/balade-sonore/1");
...
//# sourceMappingURL=5-0db9daa2.js.map
